...
<div class="flex flex-col w-1/5 h-full overflow-y-auto transition-opacity bg-gray-100 sidebar-left" class:hidden={$selectedProduct === null}>
    ...
    {#if $selectedProduct}
        ...
        <div class="flex flex-col items-center w-full p-4 overflow-y-auto" style="max-height: 90vh;">
...
<!-- Right Sidebar -->
<div class="flex-none w-1/5 mx-4 transition-opacity bg-gray-100 sidebar-right" class:hidden={$selectedProduct === null}>
